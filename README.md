...
-  [MySQL](https://dev.mysql.com/downloads/) Banco de dados
...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/scaglia-aylla1/blogpessoal.git) dentro da pasta do *Workspace* do STS

```bash
git clone https://github.com/scaglia-aylla1/blogpessoal.git
```
...
Este é um repositório de estudos, mas contribuições são sempre bem-vindas! Caso tenha sugestões, correções ou melhorias, fique à vontade para:
...
Desenvolvido por [**Aylla Scaglia**](https://github.com/scaglia-aylla1), no bootcamp da [Generation](https://brazil.generation.org/). 
